...
axes[1].plot(t, (y_det - y_eq) * 1e6, label="deterministic")
axes[1].plot(t_brownian,(y_brownian - y_eq) * 1e6,linewidth=0.8,alpha=0.75,label="with Brownian motion")
axes[1].axhline(0, linestyle=":", color="black")
axes[1].set_ylabel("y displacement / micrometres")
axes[1].legend()
axes[1].grid()

axes[2].plot(t, (z_det - z_eq) * 1e6, label="deterministic")
axes[2].plot(t_brownian,(z_brownian - z_eq) * 1e6,linewidth=0.8,alpha=0.75,label="with Brownian motion")
