...
def positive_normalized_fft(signal, time_values):
...
baoab_x_freqs, baoab_x_amp = positive_normalized_fft(x_baoab - x_eq, t_baoab)
baoab_z_freqs, baoab_z_amp = positive_normalized_fft(z_baoab - z_eq, t_baoab)

plt.figure(figsize=(8, 5))
plt.loglog(baoab_x_freqs, baoab_x_amp, label="BAOAB x spectrum")
plt.axvline(nyquist_frequency, color="red", linestyle=":", label="Nyquist limit")
plt.xlim(2e0, fft_plot_max/10)
plt.ylim(1e-12, 1.2)
plt.xlabel("Frequency / Hz")
plt.ylabel("Normalized amplitude")
plt.title("Log-log Fourier spectrum of BAOAB x motion")
plt.legend()
plt.grid(True, which="both")
plt.show()

plt.figure(figsize=(8, 5))
plt.loglog(baoab_z_freqs, baoab_z_amp, color="tab:orange", label="BAOAB z spectrum")
plt.axvline(nyquist_frequency, color="red", linestyle=":", label="Nyquist limit")
plt.xlim(2e0, fft_plot_max/10)
plt.ylim(1e-12, 1.2)
plt.xlabel("Frequency / Hz")
plt.ylabel("Normalized amplitude")
plt.title("Log-log Fourier spectrum of BAOAB z motion")
plt.legend()
plt.grid(True, which="both")
plt.show()

laser_effect_x_freqs, laser_effect_x_amp = positive_normalized_fft(
    x_laser_noise_difference,
    t_baoab
)
laser_effect_z_freqs, laser_effect_z_amp = positive_normalized_fft(
    z_laser_noise_difference,
    t_baoab
)

plt.figure(figsize=(8, 5))
plt.loglog(laser_effect_x_freqs, laser_effect_x_amp, label="x laser-noise effect")
plt.loglog(
...
plt.xlabel("Frequency / Hz")
plt.ylabel("Normalized amplitude")
plt.title("Fourier spectrum of isolated laser-noise displacement effect")
plt.legend()
plt.grid(True, which="both")
plt.show()
